...
export default class TabBarTop extends PureComponent {
  ...
  render() {
    ...
    return <TabBar {...props} onTabPress={this._onTabPress} renderIcon={this._renderIcon} renderLabel={this._renderLabel} />;
  }
}
...
TabBarTop.propTypes = {
  ...
  getTabPressCallback: require('prop-types').func.isRequired,
