...
class TabView extends PureComponent {
  ...
  _getTabPressCallback = ({ route }) => {
    const tabBar = this.props.router.getScreenOptions(this.props.childNavigationProps[route.key]);
  ...
  _renderTabBar = props => {
    ...
    return <TabBarComponent {...props} {...tabBarOptions} navigation={this.props.navigation} getLabel={this._getLabel} getTabPressCallback={this._getTabPressCallback} renderIcon={this._renderIcon} animationEnabled={animationEnabled} />;
  };
