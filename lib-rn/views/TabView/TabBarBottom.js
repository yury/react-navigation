...
_onTabPress=function(scene){var _this$props=
_this.props,getTabPressCallback=_this$props.getTabPressCallback,jumpToIndex=_this$props.jumpToIndex;
var onTabPress=getTabPressCallback(scene);
onTabPress(scene);
jumpToIndex(scene.index);
},_this.

_renderLabel=function(scene){var _this$props2=
...
_this.props,position=_this$props2.position,navigationState=_this$props2.navigationState,activeTintColor=_this$props2.activeTintColor,inactiveTintColor=_this$props2.inactiveTintColor,labelStyle=_this$props2.labelStyle,showLabel=_this$props2.showLabel;
if(showLabel===false){
return null;
}var
...
_renderIcon=function(scene){var _this$props3=
...
_this.props,position=_this$props3.position,navigationState=_this$props3.navigationState,activeTintColor=_this$props3.activeTintColor,inactiveTintColor=_this$props3.inactiveTintColor,renderIcon=_this$props3.renderIcon,showIcon=_this$props3.showIcon;
if(showIcon===false){
return null;
}
return(
...
return(
_react2.default.createElement(_reactNative.TouchableWithoutFeedback,{key:route.key,onPress:function onPress(){return _this2._onTabPress(scene);}},
