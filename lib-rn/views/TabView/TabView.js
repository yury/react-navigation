...
_getTabPressCallback=function(_ref4){var route=_ref4.route;
var tabBar=_this.props.router.getScreenConfig(
_this.props.childNavigationProps[route.key],
'tabBar');
...
_renderIcon=function(_ref5){var focused=_ref5.focused,route=_ref5.route,tintColor=_ref5.tintColor;
var tabBar=_this.props.router.getScreenConfig(
_this.props.childNavigationProps[route.key],
'tabBar');
...
getTabPressCallback:_this._getTabPressCallback,
